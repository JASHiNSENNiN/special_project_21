...
<body>
    ...
    <script>
        function printPage() {
            const rowprofile = document.getElementsByClassName('row-profile');
            ...
            printWindow.document.write(rowprofile.innerHTML);
            printWindow.document.write(piechart_3d.innerHTML);
            printWindow.document.write(dp_chart_div.innerHTML);
            printWindow.document.write(wptopxdiv.innerHTML);
            printWindow.document.write(protopxdiv.innerHTML);
            printWindow.document.write(ldtopxdiv.innerHTML);
