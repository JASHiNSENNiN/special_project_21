                                        ...
                                        <div class="card mb-4 mb-xl-0">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="small font-italic text-muted mb-4">JPG or PNG no larger than
                                                    5 MB<br> *Upload photo of the company logo.</div>
                                                    ...
                                                    <form action="dataForm">
                                                        ...
                                                        <select class="form-control" id="inputStrand" name="strand"
                                                            ...
                                                            <input class="form-control" type="number" id="numberInput"
                                                                name="phone_number" placeholder="09x-xxx-xxxx"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <select class="form-control" id="inputStrand" name="strand"
                                                                required>
                                                                <option
                                                                    value="<?php echo htmlspecialchars($profile_data['strand'] ?? ''); ?>">
                                                                    <?php echo htmlspecialchars($profile_data['strand'] ?? ''); ?>
                                                                </option>
                                                                <option value="STEM"
                                                                    <?php echo (isset($profile_data['strand']) && $profile_data['strand'] == 'STEM') ? 'selected' : ''; ?>>
                                                                    STEM</option>
                                                                <option value="HUMSS"
                                                                    <?php echo (isset($profile_data['strand']) && $profile_data['strand'] == 'HUMSS') ? 'selected' : ''; ?>>
                                                                    HUMSS</option>
                                                                <option value="ABM"
                                                                    <?php echo (isset($profile_data['strand']) && $profile_data['strand'] == 'ABM') ? 'selected' : ''; ?>>
                                                                    ABM</option>
                                                                <option value="GAS"
                                                                    <?php echo (isset($profile_data['strand']) && $profile_data['strand'] == 'GAS') ? 'selected' : ''; ?>>
                                                                    GAS</option>
                                                                <option value="TVL"
                                                                    <?php echo (isset($profile_data['strand']) && $profile_data['strand'] == 'TVL') ? 'selected' : ''; ?>>
                                                                    TVL</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" id="provinces" name="province">
                                                                <option selected value="">
                                                                    <?php echo htmlspecialchars($profile_data['province'] ?? ''); ?>
                                                                </option>
                                                        ...
                                                        <div ss="col-md-12">
                                                            <label class="small mb-1" for="inputOrganizationName">About
                                                                Us</label>
                                                            <input class="form-control" id="inputAddressInput"
                                                                name="about_us" type="text" placeholder="About Us"
